...
function ChannelHistory:CreateDebugFrame()
	...
	title:SetText("Channel History (Debug)")
	...
	local midLabel = f.middle:CreateFontString(nil, "OVERLAY", "GameFontHighlight")
	midLabel:SetPoint("TOPLEFT", f.middle, "TOPLEFT", 10, -10)
	midLabel:SetText("Channels/Filter (placeholder)")
