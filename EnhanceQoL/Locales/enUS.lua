...
L["InventoryUpgrade"] = "Inventory & Upgrade"
...
L["showBindOnBagItems"] = "Display Bind types"
L["showBindOnBagItemsDesc"] = "Display %s (BoE), %s (WuE), and %s (WB) as an addition to item level on items"
...
L["SettingsItemInvHeaderDisplayItemLevel"] = "Display item level"
L["SettingsItemInvDisplayBags"] = "Bags"
L["SettingsItemInvDisplayBagsDesc"] = "Shows item level text directly on items in your bags."
L["SettingsItemInvDisplayBank"] = "Bank frame"
L["SettingsItemInvDisplayBankDesc"] = "Shows item level text when viewing items in the bank."
L["SettingsItemInvDisplayMerchant"] = "Merchant frame"
L["SettingsItemInvDisplayMerchantDesc"] = "Adds item level text to vendor items so you can compare upgrades quickly."
L["SettingsItemInvBagIlvlPosition"] = "Item level anchor"
L["SettingsItemInvBagIlvlPositionDesc"] = "Choose where the item level text is anchored on bag item buttons."
L["SettingsItemInvHeaderBagOverlays"] = "Bag overlays"
L["SettingsItemInvShowBindStatus"] = "Show bind status"
L["SettingsItemInvShowBindStatusDesc"] = "Adds bind type (%s, %s, %s) next to item level."
L["SettingsItemInvFadeQuality"] = "Fade profession-quality borders"
L["SettingsItemInvFadeQualityDesc"] = "Dims the profession-quality border overlay while you search or filter your bags."
L["SettingsItemInvShowUpgradeIndicators"] = "Show upgrade indicators"
L["SettingsItemInvShowUpgradeIndicatorsDesc"] = "Displays the upgrade arrow overlay on equipment that appears to be an upgrade."
L["SettingsItemInvUpgradeIconPosition"] = "Upgrade icon anchor"
L["SettingsItemInvUpgradeIconPositionDesc"] = "Choose where the upgrade arrow overlay is anchored on item buttons."
L["SettingsItemInvHeaderBagInteraction"] = "Bag interaction"
L["SettingsItemInvBagFilterMenu"] = "Enable combined bag filter menu"
L["SettingsItemInvBagFilterMenuDesc"] = "Adds a draggable filter window to combined bags. Hold %s to reposition it."
L["SettingsItemInvCloseBagsAuctionHouse"] = "Close bags at the Auction House"
L["SettingsItemInvCloseBagsAuctionHouseDesc"] = "Automatically closes your bags when you open the Auction House for a cleaner view."
L["SettingsItemInvHeaderContainerActions"] = "Container action button"
L["SettingsItemInvContainerButton"] = "Enable container action button"
L["SettingsItemInvContainerButtonDesc"] = "Displays a quick-use button whenever a usable container item is detected. Use Edit Mode to move the button."
L["SettingsItemInvContainerBlacklist"] = "Remove blacklisted item"
L["SettingsItemInvContainerBlacklistDesc"] = "Select a blacklisted item to remove it. Shift-Right-Click the container action button to add the current item."
L["SettingsItemInvContainerBlacklistConfirm"] = "Remove %s from the blacklist?"
L["SettingsItemInvHeaderConfirmation"] = "Confirmation automation"
L["SettingsItemInvConfirmDelete"] = 'Fill "%s" into delete confirmation'
L["SettingsItemInvConfirmDeleteDesc"] = "Automatically enters the required text when destroying items."
L["SettingsItemInvConfirmPatronOrder"] = "Confirm using own materials on %s orders"
L["SettingsItemInvConfirmPatronOrderDesc"] = "Skips the confirmation when submitting work orders with your reagents."
L["SettingsItemInvConfirmTradeTimer"] = "Confirm trade timer removal"
L["SettingsItemInvConfirmTradeTimerDesc"] = "Automatically confirms removing the trade timer when trading bound loot."
L["SettingsItemInvConfirmReplaceEnchant"] = "Confirm enchant replacement"
L["SettingsItemInvConfirmReplaceEnchantDesc"] = "Skips the warning when replacing an enchant."
L["SettingsItemInvConfirmReplaceSocket"] = "Confirm socket replacement"
L["SettingsItemInvConfirmReplaceSocketDesc"] = "Skips the warning when replacing sockets."

L["SettingsCharInspectCategory"] = "Character & Inspect"
L["SettingsCharInspectHeaderCharacter"] = "Character display"
L["SettingsCharInspectCharacterIlvl"] = "Show item level overlays"
L["SettingsCharInspectCharacterIlvlDesc"] = "Displays item level text on equipment slots in the character frame."
L["SettingsCharInspectCharacterGems"] = "Show socketed gems"
L["SettingsCharInspectCharacterGemsDesc"] = "Displays gem icons directly on equipment so socketed items stand out without hovering."
L["SettingsCharInspectCharacterEnchants"] = "Show enchant status"
L["SettingsCharInspectCharacterEnchantsDesc"] = "Shows enchant indicators on gear in the character frame for instant visibility."
L["SettingsCharInspectCharacterGemTip"] = "Show gem socket tooltip"
L["SettingsCharInspectCharacterGemTipDesc"] = "Adds tooltips to gem icons with the inserted gem details (requires gem icons to be enabled)."
L["SettingsCharInspectCharacterDurability"] = "Show durability indicator"
L["SettingsCharInspectCharacterDurabilityDesc"] = "Adds an overall durability counter to the character frame."
L["SettingsCharInspectCharacterCatalyst"] = "Show Catalyst charges"
L["SettingsCharInspectCharacterCatalystDesc"] = "Displays your Catalyst charge count on the character frame."
L["SettingsCharInspectHeaderInspect"] = "Inspect display"
L["SettingsCharInspectInspectIlvl"] = "Show inspected item level"
L["SettingsCharInspectInspectIlvlDesc"] = "Displays item level text when inspecting other players."
L["SettingsCharInspectInspectGems"] = "Show inspected gems"
L["SettingsCharInspectInspectGemsDesc"] = "Shows socketed gems on inspected equipment."
L["SettingsCharInspectInspectEnchants"] = "Show inspected enchants"
L["SettingsCharInspectInspectEnchantsDesc"] = "Shows enchant information when inspecting another player."
L["SettingsCharInspectInspectGemTip"] = "Show inspected gem tooltip"
L["SettingsCharInspectInspectGemTipDesc"] = "Adds socket tooltips to inspected equipment slots."
L["SettingsCharInspectHeaderPositioning"] = "Item level anchor"
L["SettingsCharInspectIlvlAnchor"] = "Character item level anchor"
L["SettingsCharInspectIlvlAnchorDesc"] = "Choose where the character-frame item level text is anchored."
L["SettingsCharInspectHeaderCatalyst"] = "Catalyst & upgrading"
L["SettingsCharInspectHeaderUtilities"] = "Quick access"
L["SettingsCharInspectShowCloakButton"] = "Show cloak upgrade button"
L["SettingsCharInspectShowCloakButtonDesc"] = "Restores the Reshii Wraps upgrade button on the character frame for quick access."
L["SettingsCharInspectInstantCatalyst"] = "Show Instant Catalyst button"
L["SettingsCharInspectInstantCatalystDesc"] = "Adds a button that converts eligible items at the Catalyst immediately, skipping the usual cast time."
L["SettingsCharInspectMovementSpeed"] = "Show movement speed stat"
L["SettingsCharInspectMovementSpeedDesc"] = "Displays your current movement speed in the character frame statistics."
L["SettingsCharInspectOpenOnUpgrade"] = "Open character frame when upgrading gear"
L["SettingsCharInspectOpenOnUpgradeDesc"] = "Automatically opens the character frame when you interact with item upgrade vendors."
L["SettingsCharInspectEnableGemHelper"] = "Enable gem helper"
L["SettingsCharInspectEnableGemHelperDesc"] = "Shows a helper panel in the socketing UI to quickly select and insert gems."

L["SettingsVendorHeaderAuctionHouse"] = "Auction House"
L["SettingsVendorAuctionPersist"] = "Remember last filters"
L["SettingsVendorAuctionPersistDesc"] = "Keeps your Auction House search and filter selections between visits."
L["SettingsVendorAuctionCurrentExpansion"] = "Auto-select current expansion"
L["SettingsVendorAuctionCurrentExpansionDesc"] = "Automatically applies the current expansion filter whenever you open the Auction House."
L["SettingsVendorHeaderRepairs"] = "Repairs & Junk"
L["SettingsVendorAutoRepair"] = "Automatically repair gear"
L["SettingsVendorAutoRepairDesc"] = "Repairs your equipment automatically when you visit a vendor that offers repairs."
L["SettingsVendorAutoRepairGuild"] = "Use guild bank for repairs"
L["SettingsVendorAutoRepairGuildDesc"] = "If available, uses guild funds for automatic repairs. Requires automatic repairs to be enabled."
L["SettingsVendorSellJunk"] = "Sell junk automatically"
L["SettingsVendorSellJunkDesc"] = "Sells poor-quality items whenever you open a vendor."
L["SettingsVendorHeaderMerchant"] = "Merchant display"
L["SettingsVendorExtendedMerchant"] = "Show 20 items per merchant page"
L["SettingsVendorExtendedMerchantDesc"] = "Expands the merchant window to 20 items per page. Disabling requires a reload."
L["SettingsVendorKnownHighlights"] = "Highlight known collectibles"
L["SettingsVendorKnownHighlightsDesc"] = "Adds a green check mark to merchant items you already learned."
L["SettingsVendorPetHighlights"] = "Dim collected battle pets"
L["SettingsVendorPetHighlightsDesc"] = "Greys out vendor pets that you already own."
L["SettingsVendorHeaderMailbox"] = "Mailbox address book"
L["SettingsVendorMailboxEnable"] = "Enable mailbox address book"
L["SettingsVendorMailboxEnableDesc"] = "Adds a searchable list of characters next to the Send Mail panel."
L["SettingsVendorMailboxRemove"] = "Remove saved recipient"
L["SettingsVendorMailboxRemoveDesc"] = "Select a saved recipient to remove them from the address book."
L["SettingsVendorMailboxRemoveConfirm"] = "Remove %s from the mailbox address book?"
L["SettingsVendorHeaderMoney"] = "Money tracking"
L["SettingsVendorMoneyEnable"] = "Track gold across characters"
L["SettingsVendorMoneyEnableDesc"] = "Adds a tooltip showing the gold carried by your other characters when you hover your currency."
L["SettingsVendorMoneyGoldOnly"] = "Show gold only"
L["SettingsVendorMoneyGoldOnlyDesc"] = "Hides silver and copper values in the money tracker tooltip."
L["SettingsVendorMoneyRemove"] = "Remove stored character"
L["SettingsVendorMoneyRemoveDesc"] = "Select a character to clear their tracked gold data."
L["SettingsVendorMoneyRemoveConfirm"] = "Remove stored gold data for %s?"
...
L["groupFinderRoleSeclection"] = "Role selection in Dungeon Finder"
...
L["SettingsCombatHeaderDungeonFinder"] = "Dungeon Finder"
L["SettingsCombatSkipSignup"] = "Skip signup confirmation"
L["SettingsCombatSkipSignupDesc"] = "Automatically accepts the Dungeon Finder signup dialog when possible. Hold Shift when you sign up to show the dialog for that attempt."
L["SettingsCombatPersistNote"] = "Remember signup note"
L["SettingsCombatPersistNoteDesc"] = "Keeps your last entered application note so it is reused on future signups."
L["SettingsCombatAutoDelve"] = "Auto-select delve powers"
L["SettingsCombatAutoDelveDesc"] = "Automatically selects a delve power when the choice window presents just one option."
L["SettingsCombatHideFormingOverlay"] = "Hide \"group forming\" overlay"
L["SettingsCombatHideFormingOverlayDesc"] = "Hides the \"group is forming\" overlay when you’re in a listing you joined but do not lead, so you can see applicant details immediately."
L["SettingsCombatMoveReset"] = "Move Dungeon Finder reset button"
L["SettingsCombatMoveResetDesc"] = "Moves the Reset Filter button from the top-right of the filter bar to the top-left for easier access."
L["SettingsCombatSortByMplus"] = "Sort applicants by Mythic+ score"
L["SettingsCombatSortByMplusDesc"] = "Orders applicants from highest to lowest Mythic+ score."
L["SettingsCombatHeaderRole"] = "Role assignment"
L["SettingsCombatSkipRoleSelect"] = "Skip role selection prompt"
L["SettingsCombatSkipRoleSelectDesc"] = "Auto-confirms the role selection popup using the chosen mode. Hold Shift to show the prompt once."
L["SettingsCombatRoleModeLabel"] = "Role selection mode"
L["SettingsCombatRoleModeDesc"] = "Choose how roles are filled when the prompt is skipped."
L["SettingsCombatRoleModeSpec"] = "Use current specialization role"
L["SettingsCombatRoleModeSpecDesc"] = "Selects the role that matches your active specialization."
L["SettingsCombatRoleModeLFD"] = "Copy Dungeon Finder roles"
L["SettingsCombatRoleModeLFDDesc"] = "Copies the role checkboxes currently selected in the Dungeon Finder window."
