...
L["SettingsCharInspectShowCloakButtonDesc"] = "Adds the cloak upgrade shortcut button back to the character frame."
L["SettingsCharInspectInstantCatalyst"] = "Show Instant Catalyst button"
L["SettingsCharInspectInstantCatalystDesc"] = "Adds a button that opens the Instant Catalyst conversion window."
