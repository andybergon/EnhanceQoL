...
| Out-of-combat-only class buff reminder | Fork-only | — | [`ef73fb86`](https://github.com/andybergon/EnhanceQoL/commit/ef73fb86) (2026-03-20) | Hides reminder during combat; also exposes glow/flask settings UI that upstream declares but doesn't surface |
